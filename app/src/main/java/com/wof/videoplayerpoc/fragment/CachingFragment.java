...
import java.io.File;
    ...
    public class CachingFragment extends Fragment implements TransferListener {
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            return inflater.inflate(R.layout.layout_exoplayer, container, false);
        }
        ...
        private File getCahceDir3(){
            return new File(mContext.getCacheDir(), "http-cacheddd-ddd-3");
        }
        ...
        public DataSource.Factory buildDataSourceFactory() {
            ...
            return new DataSource.Factory() {
                ...
                public DataSource createDataSource() {
                    ...
                    SimpleCache simpleCache = new SimpleCache(getCahceDir3(), evictor);
